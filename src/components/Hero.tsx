        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-foreground leading-tight">
              Pure{' '}
              <span className="text-primary">Refreshment</span>
              <br />
              from Nature
            </h1>
            
            <p className="text-xl text-muted-foreground max-w-lg">
              Discover the perfect blend of natural flavors. Crafted with care, 
              every sip brings you closer to nature's purest essence.
            </p>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-border/50">
              <div>
                ...
                <p className="text-muted-foreground text-sm">Perfect Size</p>
              </div>
              <div className="w-px h-12 bg-border" />
              <div>
                <p className="text-3xl font-bold text-foreground">0g</p>
                <p className="text-muted-foreground text-sm">Added Sugar</p>
              </div>
              <div className="w-px h-12 bg-border" />
              <div>
                <p className="text-3xl font-bold text-foreground">3</p>
                <p className="text-muted-foreground text-sm">Delicious Flavors</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-end justify-center gap-[-20px]">
                <img
                  ...
                  className="h-64 md:h-80 object-contain drop-shadow-2xl -rotate-6 translate-x-8 animate-float"
                  style={{ animationDelay: '0s' }}
                />
                <img
                  src={aquaNatural}
                  alt="Aqua Naturale Natural"
                  className="h-72 md:h-96 object-contain drop-shadow-2xl z-10 animate-float"
